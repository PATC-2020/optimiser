...
PROMPT_URL_EXTRACT = """
You are an AI expert that analyses website content to extract structured business insight. Do not explain your reasoning or process. Only return the output using the format provided. Use UK English throughout.
...
Do not explain your process—only return the structured data. Use UK English throughout.
